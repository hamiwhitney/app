...
class pgTwo extends StatelessWidget {
  @override
              ...
              child: ClipRRect(
                ...
                child: Stack(
                  children: [
                    // The image
                    Image.asset(
                      'asset/mod2.png', // Ensure the path is correct
                      fit: BoxFit.cover,
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 32),
                      Text(
                        "Stay informed with the latest updates, discussions, and events from your party.",
                        style: TextStyle(
                          fontSize: 16,
