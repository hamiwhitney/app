...
class pgOne extends StatelessWidget {
  @override
              ...
              child: ClipRRect(
                ...
                child: Stack(
                  children: [
                    // The image
                    Image.asset(
                      'asset/mod1.png', // Ensure the path is correct
                      fit: BoxFit.cover,
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 32),
                      Text(
                        "Join your political party's group and connect with fellow members in one centralized platform.",
                        style: TextStyle(
                          fontSize: 16,
